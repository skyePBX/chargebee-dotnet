...
namespace ChargeBee.Models
{
    public class InvoiceEstimate : Resource
    {
        ...
        public List<InvoiceEstimateLineItem> LineItems => GetResourceList<InvoiceEstimateLineItem>("line_items");

        public List<InvoiceEstimateDiscount> Discounts => GetResourceList<InvoiceEstimateDiscount>("discounts");

        public List<InvoiceEstimateTax> Taxes => GetResourceList<InvoiceEstimateTax>("taxes");

        public List<InvoiceEstimateLineItemTax> LineItemTaxes =>
            GetResourceList<InvoiceEstimateLineItemTax>("line_item_taxes");

        public List<InvoiceEstimateLineItemTier> LineItemTiers =>
            GetResourceList<InvoiceEstimateLineItemTier>("line_item_tiers");

        public List<InvoiceEstimateLineItemDiscount> LineItemDiscounts =>
            GetResourceList<InvoiceEstimateLineItemDiscount>("line_item_discounts");
